	...
	return (
		<div className="w-full overflow-hidden bg-gradient-to-b from-sky-50 via-white to-emerald-50">
			...
			<section className="relative mx-auto max-w-7xl px-6 pb-24">
				<div className="absolute left-0 top-12 h-64 w-64 rounded-full bg-sky-100/80 blur-3xl" />
				<div className="absolute bottom-12 right-0 h-64 w-64 rounded-full bg-emerald-100/80 blur-3xl" />
				...
				<div className="relative grid items-center gap-10 lg:grid-cols-[1fr_1.1fr]">
					<motion.div
						...
						transition={{ duration: 0.7 }}
						viewport={{ once: true }}
						className="rounded-3xl border border-sky-100 bg-white p-8 shadow-xl md:p-10"
					>
						<span className="mb-5 inline-flex items-center rounded-full bg-sky-100 px-4 py-2 text-sm font-semibold text-sky-700">
							Nuestra razón de ser
						</span>

						<h2 className="mb-6 text-3xl font-extrabold text-slate-900 md:text-4xl">
					...
					>
						<div className="rounded-3xl bg-gradient-to-br from-sky-500 to-sky-700 p-7 text-white shadow-xl">
							<UsersRound size={38} className="mb-5" />

							<h3 className="mb-3 text-2xl font-bold">Talento visible</h3>
						...
						<div className="rounded-3xl bg-gradient-to-br from-emerald-500 to-emerald-700 p-7 text-white shadow-xl sm:mt-10">
						...
						<div className="rounded-3xl bg-gradient-to-br from-amber-400 to-orange-500 p-7 text-white shadow-xl">
							<Scale size={38} className="mb-5" />

							<h3 className="mb-3 text-2xl font-bold">Igualdad real</h3>
						...
						<div className="rounded-3xl bg-gradient-to-br from-violet-500 to-purple-700 p-7 text-white shadow-xl sm:mt-10">
							<ShieldCheck size={38} className="mb-5" />

							<h3 className="mb-3 text-2xl font-bold">Acompañamiento</h3>
			...
			<section className="relative overflow-hidden bg-white py-24">
				...
				<div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
					...
					>
						...
						<div className="rounded-3xl border border-sky-100 bg-gradient-to-r from-sky-50 to-emerald-50 p-6">
